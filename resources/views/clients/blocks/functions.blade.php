...
<div class="col-6 bg-secondary rounded m-1 ">
    <div class="row ">
        <button class="col btn m-0 pt-2 p-2 pb-2 text-white">Thêm vào<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="col  m-0 p-0 bi bi-cart3" viewBox="0 0 16 16">
