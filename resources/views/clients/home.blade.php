...
<div class="container">
                ...
                <div
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="d-flex justify-content-center">
                            <a class="btn col-5 bg-secondary rounded m-1 p-0 d-flex justify-content-center align-items-center" href="/detail_product/{{ $phone->id }}">
                            ...
                            <div class="col-5 bg-secondary rounded m-1 d-flex justify-content-center align-items-center bg-success">
    ...
    <div class="bg-white rounded border border-black mt-5">
        ...
        <div class="row m-3 d-lex justify-content-center">
            ...
            <div class="col-2 m-2 p-0 border border-black rounded bg-warning bg-opacity-10" style="position: relative;">
                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                    <div class="text-center" id="card-container">
                        <img class="mt-3 image" style="height: 120px;" src="{{$product->image}}" alt="" id="card-image">
                        <b>
                            <p class="name" id="card-name" style="white-space: normal; word-wrap: break-word; overflow: hidden; max-height: 3.6em;">{{ $product->name }}</p>
                        </b>
                        <p id="card-price">{{ $product->price }}đ</p>
                        <p class="bg-danger text-white rounded m-2" id="card-discount">Giảm giá lên đến: {{ $product->discount }}%</p>
