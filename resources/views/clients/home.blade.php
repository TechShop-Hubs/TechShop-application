...
<div class="container">
    ...
    <div class=" bg-white rounded border border-black ">
        <div class="ms-4 mt-2"><b>
                <p class="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-fire" viewBox="0 0 16 16">
        ...
        <div class="row m-3 position-relative">
            ...
            <div class="col-2 m-2 p-0 d-flex justify-content-center border border-black rounded bg-warning bg-opacity-10">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="row ">
                        <a class="btn col-4 bg-secondary rounded  m-3 p-0 justify-content-center d-flex align-items-center" href="/detail_product/{{ $product->id }}" >
                        ...
                        <div class="col-4 mb-0 m-3 p-0">
                            <form class="" action="{{ route('postWishList',[$product->id]) }}" method="post">
                                @csrf
                                <button class="btn btn-lg btn-danger text-white">Thích</button>
                            </form>
                        </div>
                        <div class="col-10 m-3 bg-secondary rounded ">
                            <form action="{{route('postCart',[$product->id])}}" method="post">
                                @csrf
                                <button class="col btn m-0 pt-4 text-white">Thêm Vào Giỏ<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="col  m-0 p-0 bi bi-cart3" viewBox="0 0 16 16">
                                        <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l.84 4.479 9.144-.459L13.89 4zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2" />
                                    </svg></button>
                            </form>
                        </div>
    ...
    <div class="bg-white rounded border border-black mt-5">
        <div class="ms-4 mt-2 "><b>
                <p class="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-fire m-0 p-0" viewBox="0 0 16 16">
                        <path d="M8 16c3.314 0 6-2 6-5.5 0-1.5-.5-4-2.5-6 .25 1.5-1.25 2-1.25 2C11 4 9 .5 6 0c.357 2 .5 4-2 6-1.25 1-2 2.729-2 4.5C2 14 4.686 16 8 16m0-1c-1.657 0-3-1-3-2.75 0-.75.25-2 1.25-3C6.125 10 7 10.5 7 10.5c-.375-1.25.5-3.25 2-3.5-.179 1-.25 2 1 3 .625.5 1 1.364 1 2.25C11 14 9.657 15 8 15" />
